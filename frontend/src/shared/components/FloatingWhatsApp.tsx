...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute -top-10 left-0 bg-surface border border-surfaceBorder text-primary px-3 py-1.5 rounded-lg text-sm shadow-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap font-body font-semibold">
        تواصل معنا
      </span>
      {/* Ripple effect */}
